    ...
    return (
      <button
        ...
        className={`
          ...
          transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-1
      ...
      >
        ...
        {children}
        {!loading && Icon && iconPosition === 'right' && <Icon className="w-4 h-4" strokeWidth={2} />}
      </button>
    )
  }
)
