    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Edit Certification" size="lg">
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
          <Button variant="secondary" type="button" onClick={handleClose} disabled={isSubmitting || isUploading}>
            Cancel
          </Button>
          <Button variant="primary" type="submit" disabled={isSubmitting || isUploading} loading={isSubmitting || isUploading}>
