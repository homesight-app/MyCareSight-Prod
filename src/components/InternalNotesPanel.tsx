...
import { Plus, Pencil, Trash2, X, Check, Loader2, FileText, Tag, Link as LinkIcon, Search } from 'lucide-react'
          ...
          <div className="border border-blue-200 rounded-xl p-4 bg-blue-50/40">
            ...
            <div className="flex items-center justify-end gap-2 mt-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-4 py-1.5 text-sm font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {addLoading ? (
          ...
          <div className="space-y-2.5 pb-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              />
            </div>
