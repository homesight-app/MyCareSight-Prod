        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-4 sm:p-6">
            ...
            <Link
              ...
              className="block w-full text-center py-2.5 px-4 bg-white border border-gray-300 hover:bg-gray-50 rounded-lg text-gray-700 font-medium transition-colors duration-150"
            >
